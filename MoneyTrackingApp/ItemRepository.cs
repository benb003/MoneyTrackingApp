...
public class ItemRepository
{
    ...
    public static void ShowAllItems()
    {
        ...
        Console.WriteLine("ITEM TYPE".PadRight(15)+"TITLE".PadRight(15)+"AMOUNT".PadRight(15)+"DATE".PadRight(15));
   ...
   public static void ViewOnlyExpenses()
    ...
    public static void EditItem()
    {
        ...
        {
            items.Remove(item);
            Console.WriteLine("Do you want to chance to an income or expense? (for income press i for expense press e)");
